import * as SDK from '../3rd/NIM_Web_NIM_v6.1.1';
import * as WebRTC from '../3rd/NIM_Web_WebRTC_v6.1.1';
import * as Netcall from '../3rd/NIM_Web_Netcall_v6.1.1';
 ...
 */
export function NetcallBridge(yx) {
    this.yx = yx;
